...
let gameManager = (function() {
    ...
    function deleteGame(id) {
        ...
        let stupidArray = [
            ...
            `CHAPITRE II : Comment le modérateur a réussi a ne pas avoir à coder une fonctionnalité grâçe au pouvoir du découragement.`,
            `Partie 1. Cliquez sur OK pour commencer.`,
            `Cliquez sur OK pour ne PAS commencer.`,
            `Vous vennez de cliquer sur OK, vous acceptez donc de ne PAS commencer. Cliquez sur OK pour confirmer.`,
            `Vous vennez d'accepter une ordre d'un script JavaScript. Cliquez sur OK si vous vous sentez mal.`,
            `Peut-être que supprimer la partie vous ferais plaisir, vous qui vous sentez mal?`,
